...
import '../../logic/state/counter_state.dart';
import '../../logic/cubit/internet_cubit.dart';
import '../../logic/state/internet_state.dart';
            ...
            BlocBuilder<InternetCubit, InternetState>(
              builder: (internetCubitBuilderContext, state) {
                if (state is InternetConnected && state.connectionType == ConnectionType.wifi) {
                  return Text(
                    'Wi-Fi',
                    style: Theme.of(internetCubitBuilderContext).textTheme.displaySmall?.copyWith(
                          color: Colors.green,
                        ),
                  );
              ...
              builder: (counterCubiBuilderContext, state) {
                if (state.counterValue < 0) {
                  return Text(
                    ...
                    style: Theme.of(counterCubiBuilderContext).textTheme.headlineMedium,
                  );
